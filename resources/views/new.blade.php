    ...
    <form class="form-horizontal row-border" name="DATAFORM" action="{{route('create')}}" method="POST">
                            ...
                            <div class="col-md-12">
                                <div class="row">                                  
                                    ...
                                    <div class="col-md-3 pull-left">
                                        ...
                                        </label> <input type="text" name="request_id" class="form-control" id='ctype' readonly value="{{$temp}}">
                                    </div>
                                    <div class="col-md-3 pull-left">
                                        <label>
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content">
                        <div class="form-group">
                            <div class="col-md-4">
                                <label class="radio">
                                    <input type="text" readonly name="clientname" class="form-control" id='cname'  placeholder="CLIENT NAME"  value="{{$cperson[0]->name}}">
                                </label>
                                <label class="radio">
                                    <input type="text" readonly name="contactname" class="form-control" id='coname' placeholder="CONTACT NAME" value="{{Auth::user()->name}}">
                                </label>
                            ...
                            <div class="col-md-4">
                                ...
                                <label class="radio">
                                    <input type="text" readonly name="contacttel" class="form-control" id='cphone' placeholder="CONTACT TELEPHONE" value="{{Auth::user()->phone}}">
                                </label>
                ...
                <div class="widget box">
                    ...
                    <div class="widget-content">
                        <div class="form-group">
                            <div class="col-md-3">
                                <label class="radio">
                                    <textarea required  cols="5" name="product_name" class="form-control" placeholder="PRODUCT NAME"></textarea>
                                </label>
                                <label class="radio">
                                    <input required type="text" name="batch_no" class="form-control"  placeholder="BATCH NO">
                                </label>
                                <label class="radio">
                                    <input required type="text" name="manufacture_date" class="form-control MNFDATE"  placeholder="MANUFACTURE DATE">
                                </label>
                                <label class="radio">
                                    <input  required type="text" name="exp_date" class="form-control EXPDATE"  placeholder="EXPIRY DATE">
                                </label>

                            </div>
                            <div class="col-md-3">
                                <label class="radio">
                                    <textarea  cols="5" name="active_ing" class="form-control" placeholder="ACTIVE INGREDIENT"></textarea>
                                </label>
                                <label class="radio">
                            ...
                            <div class="col-md-3">
                                <label class="radio">
                                    <textarea required  cols="5" name="label_claim" class="form-control" placeholder="LABELCLAIM"></textarea>
                                </label>
                                <label class="radio">
                                    <input required type="text" name="sample_qty" class="form-control"  placeholder="QUANTITY SUBMITTED">
                            ...
                            <div class="col-md-3">
                                <label class="radio">
                                    <textarea required cols="5" name="presentation" class="form-control" placeholder="PRESENTATION"></textarea>
                                </label>
                                <label class="radio">
                    ...
                    <div class="widget-content">
                        <div class="form-group">
                            <div class="col-md-4">
                                ...
                                @foreach($wet as $w)
                                <label class="radio">
                                    <input type="checkbox" class="uniform" value="{{$w->id}}" name="tests[]"> {{$w->name}}
                                </label>
                                @endforeach
                            ...
                            <div class="col-md-4">
                                ...
                                @foreach($micro as $m)
                                <label class="radio">
                                    <input type="checkbox" class="uniform" value="{{$m->id}}" name="tests[]"> {{$m->name}}
                                </label>
                                @endforeach
                            ...
                            <div class="col-md-4">
                                ...
                                @foreach($med as $e)
                                <label class="radio">
                                    <input type="checkbox" class="uniform" value="{{$e->id}}" name="tests[]"> {{$e->name}}
                                </label>
                                @endforeach
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="widget box">
                    <div class="widget-header">
                        <h4><i class="icon-reorder"></i> Method of Analysis</h4>
                    </div>
                    <div class="widget-content">
                        <div class="form-group">
                            ...
                            <div class="col-md-3">                              
                                <label class="radio">
                                    <select required class="form-control" id="METHODSPICK" name="method">
                                        ...
                                        @foreach($meth as $e)
                                        <option value="{{$e->id}}">{{$e->method}}</option>                                      
                                        @endforeach
                    ...
                    <div class="widget-content">
                        <div class="form-group">
                            <div class="col-md-4">
                                ...
                                <label class="radio">
                                    <input required type="text" name="manufacturer_name" class="form-control"  placeholder="MANUFACTURER NAME">
                                </label>
                            ...
                            <div class="col-md-4">
                                <label class="radio">
                                    <textarea required cols="5" name="manufacturer_add" class="form-control" placeholder="MANUFACTURER ADDRESS"></textarea>
                                </label>
