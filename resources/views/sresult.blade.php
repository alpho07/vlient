            ...
            <div class="widget-content">
                <form class="form-horizontal row-border" action="{{url('search')}}" method="GET">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <div class="col-md-10">
                                <input value="{{$keyword}}" type="text" name="keyword" title="Track by Sample Name, Batch No. or Labreference No." class="form-control bs-tooltip" placeholder="Enter Sample Name, Batch No. or Labreference No.">
                            </div>
                            <div class="col-md-2">
                    ...
                    <table class="table table-striped .table-bordered">   
                        <tbody>
                            ...
                            <tr><td>No Sample found for your search term... 
                                    <a href="{{url('caveats/create')}}" class="btn btn-success btn-lg">Submit Sample</a>  or   <a href="{{url('/')}}" class="btn btn-primary btn-lg">Explore</a>
                                </td> 
                            </tr>
                            @endif
                        </tbody>
